...
VALUES (1, '参数管理', 1, 'xin.altitude.cms.system.controller.SysConfigController.add()', 'POST', 1, 'admin', NULL,
       ...
       (24, '角色管理', 2, 'xin.altitude.cms.system.controller.SysRoleController.edit()', 'PUT', 1, 'admin', '',
        '/system/role',
        '127.0.0.1', '内网IP',
       ...
       (38, '通知公告', 1, 'xin.altitude.cms.system.controller.SysNoticeController.add()', 'POST', 1, 'admin', '',
        ...
        '{\"msg\":\"操作成功\",\"code\":200}', 0, '', NULL),
       (39, '角色管理', 1, 'xin.altitude.cms.system.controller.SysRoleController.add()', 'POST', 1, 'admin', '',
        '/system/role',
        '127.0.0.1', '内网IP',
        ...
        '{\"msg\":\"操作成功\",\"code\":200}', 0, '', NULL),
       (40, '角色管理', 4, 'xin.altitude.cms.system.controller.SysRoleController.selectAuthUserAll()', 'PUT', 1, 'admin',
        '',
