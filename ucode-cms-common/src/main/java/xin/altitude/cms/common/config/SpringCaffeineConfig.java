...
public class SpringCaffeineConfig {
    ...
    public CacheManager caffeineCacheManager() {
        ...
        caches.add(new CaffeineCache(CNTC.CACHE_5SECS, expire(5, TimeUnit.SECONDS)));
        ...
        caches.add(new CaffeineCache(CNTC.CACHE_1MINS, expire(1, TimeUnit.MINUTES)));
        caches.add(new CaffeineCache(CNTC.CACHE_3MINS, expire(3, TimeUnit.MINUTES)));
        caches.add(new CaffeineCache(CNTC.CACHE_5MINS, expire(5, TimeUnit.MINUTES)));
    ...
    public Cache<Object, Object> expire(long duration, TimeUnit unit) {
